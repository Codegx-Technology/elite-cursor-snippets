...
// [GOAL]: Provide a consistent, enterprise-grade card for grouping content.
// [CONSTRAINTS]: Use Tailwind CSS, support various content sections (header, content, footer).
